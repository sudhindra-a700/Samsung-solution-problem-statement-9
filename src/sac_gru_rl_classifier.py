...
class SACActorNetwork(Model):
    def __init__(self, state_dim, action_dim=4, hidden_units=64):
...
class SACGRUClassifier:
    ...
    def __init__(self, sequence_length=1, feature_dim=7, hidden_units=64, action_dim=4):
        ...
        self.actor = SACActorNetwork(state_dim, action_dim=self.action_dim, hidden_units=hidden_units)
        self.critic1 = SACCriticNetwork(state_dim, action_dim=self.action_dim, hidden_units=hidden_units)
        self.critic2 = SACCriticNetwork(state_dim, action_dim=self.action_dim, hidden_units=hidden_units)
        self.target_critic1 = SACCriticNetwork(state_dim, action_dim=self.action_dim, hidden_units=hidden_units)
        self.target_critic2 = SACCriticNetwork(state_dim, action_dim=self.action_dim, hidden_units=hidden_units)
